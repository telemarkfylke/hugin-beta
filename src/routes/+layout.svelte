...
<main>
	<Menu authenticatedUser={data.authenticatedUser} appName={data.APP_CONFIG.NAME} isStudent={data.authenticatedUser.roles.includes(data.APP_CONFIG.APP_ROLES.STUDENT)} />
